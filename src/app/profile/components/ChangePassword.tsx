...
const ChangePasswordForm = () => {
    ...
    return (
        <div>
            ...
            <h3 className="text-xl font-semibold mb-4 cursor-pointer inline-block" onClick={() => setOpenChangePasswordForm(!openChangePasswordForm)}>
                Change Password
                <span className={`ml-1 ${!openChangePasswordForm ? 'transform rotate-180' : ''} inline-block`}>
